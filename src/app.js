...
// Capture rawBody before JSON parsing for webhook signature verification
...
app.get('/health', (req, res) => {
  res.json({ status: 'ok', service: 'vaulte-backend', environment: process.env.NODE_ENV, ai_enabled: process.env.AI_ENABLED, 
    squad_mode: process.env.SQUAD_SKIP_BANK_VERIFICATION, timestamp: new Date().toISOString() });
});
